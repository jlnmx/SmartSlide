...
export default function ImportPage() {
  const [popupType, setPopupType] = useState(null); // State to track which popup is visible
  ...
  return (
    <div className="import-container">
      <h1 className="title">Create with AI</h1>
      <div className="card-container">
        {/* Start from a Topic Card */}
